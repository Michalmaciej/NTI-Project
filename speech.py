...
Label(Top_frame,text="TEXT TO SPEECH",font="arial 20 bold",bg = "white",fg="#305065").place(x=150,y=20)

translate1=Button(Top_frame,text="Menu",font=("Roboto",15),activebackground="darkgray",cursor="hand2",bd=0,width=10, height=2,bg="#305065",fg="white",command=back_menu)
translate1.place(x=420,y=20)
...
#buttons
image_icon1=PhotoImage(file="images/speaking.png")
