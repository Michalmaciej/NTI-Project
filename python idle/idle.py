...
#output code
code_output=Text(root,font="cosnolas 15",bg="#323846",fg="lightgreen")
...
Button(root,image=Open,bg="#323846",bd=0,activebackground="#323846",command=open_f).place(x=30,y=30)
Button(root,image=Save,bg="#323846",bd=0,activebackground="#323846",command=save).place(x=30,y=145)
Button(root,image=Run,bg="#323846",bd=0,activebackground="#323846",command=run).place(x=30,y=260)
