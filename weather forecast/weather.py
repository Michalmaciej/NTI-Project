...
def getWeather():
    ...
    #weather
    api="https://api.openweathermap.org/data/3.0/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude=hourly&appid=646824f2b7b86caffec1d0b16ea77f79"
...
image_icon=PhotoImage(file="Imgages/logo.png")
...
myimage_icon=Button(Search_icon,borderwidth=0,cursor="hand2",bg="#203243",command=getWeather)
...
t.place(x=150,y=120)
h=Label(root,text="temp",font=("Helvetica",11),fg="#white",bg="#203243")
h.place(x=150,y=140)
p=Label(root,text="temp",font=("Helvetica",11),fg="#white",bg="#203243")
p.place(x=150,y=160)
w=Label(root,text="temp",font=("Helvetica",11),fg="#white",bg="#203243")
w.place(x=150,y=180)
d=Label(root,text="temp",font=("Helvetica",11),fg="#white",bg="#203243")
d.place(x=150,y=200)
