...
translate1=Button(root,text="Menu",font=("Roboto",15),activebackground="grey",cursor="hand2",bd=0,width=10, height=2,bg="white",fg="black",command=back_menu)
translate1.place(x=250,y=600)
