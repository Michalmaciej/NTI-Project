...
Round_box=PhotoImage(file="images/Rectangle 5.png")
...
Search_image=PhotoImage(file="images/Rectangle 6.png")
myimage=Label(image=Search_image,bg="#57adff")
myimage.place(x=290,y=127)

textfield=tk.Entry(root,justify="center",width=15,font=('poppins',25,"bold"),bg="#203243",border=0,fg="white")
textfield.place(x=390,y=135)
textfield.focus()

weat_image=PhotoImage(file="images/sun.png")
weatherimage=Label(root,image=weat_image,bg="#203243")
weatherimage.place(x=310,y=137)

Search_icon=PhotoImage(file="images/search.png")
myimage_icon=Button(image=Search_icon,borderwidth=0,cursor="hand2",bg="#203243",activebackground="#203243",command=getWeather)
myimage_icon.place(x=735,y=137)
...
#bottom boxes
firstbox=PhotoImage(file="images/Rectangle 11.png")
secondbox=PhotoImage(file="images/Rectangle 10.png")
...
#first cell
firstframe=Frame(root,width=210,height=132,bg="#2E2E2E")
firstframe.place(x=35, y=315)

day1=Label(firstframe,font="arial 20",bg="#2E2E2E",fg="#fff")
day1.place(x=100,y=5)

firstimage=Label(firstframe,bg="#2E2E2E")
firstimage.place(x=1,y=15)

day1temp=Label(firstframe,bg="#2E2E2E",fg="#57adff",font="arial 15 bold")
day1temp.place(x=100,y=50)

#second cell
secondframe=Frame(root,width=70,height=115,bg="#2E2E2E")
secondframe.place(x=305, y=325)

day2=Label(secondframe,bg="#2E2E2E",fg="#fff")
day2.place(x=10,y=5)

secondimage=Label(secondframe,bg="#2E2E2E")
secondimage.place(x=7,y=20)

day2temp=Label(secondframe,bg="#2E2E2E",fg="#fff")
day2temp.place(x=2,y=70)

#third cell
thirdframe=Frame(root,width=70,height=115,bg="#2E2E2E")
thirdframe.place(x=405, y=325)

day3=Label(thirdframe,bg="#2E2E2E",fg="#fff")
day3.place(x=10,y=5)

thirdimage=Label(thirdframe,bg="#2E2E2E")
thirdimage.place(x=7,y=20)

day3temp=Label(thirdframe,bg="#2E2E2E",fg="#fff")
day3temp.place(x=2,y=70)

#fourth cell
fourthframe=Frame(root,width=70,height=115,bg="#2E2E2E")
fourthframe.place(x=505, y=325)

day4=Label(fourthframe,bg="#2E2E2E",fg="#fff")
day4.place(x=10,y=5)

fourthimage=Label(fourthframe,bg="#2E2E2E")
fourthimage.place(x=7,y=20)

day4temp=Label(fourthframe,bg="#2E2E2E",fg="#fff")
day4temp.place(x=2,y=70)

#fifth cell
fifthframe=Frame(root,width=70,height=115,bg="#2E2E2E")
fifthframe.place(x=605, y=325)

day5=Label(fifthframe,bg="#2E2E2E",fg="#fff")
day5.place(x=10,y=5)

fifthimage=Label(fifthframe,bg="#2E2E2E")
fifthimage.place(x=7,y=20)

day5temp=Label(fifthframe,bg="#2E2E2E",fg="#fff")
day5temp.place(x=2,y=70)

#sixth cell
sixthframe=Frame(root,width=70,height=115,bg="#2E2E2E")
sixthframe.place(x=705, y=325)

day6=Label(sixthframe,bg="#2E2E2E",fg="#fff")
day6.place(x=10,y=5)

sixthimage=Label(sixthframe,bg="#2E2E2E")
sixthimage.place(x=7,y=20)

day6temp=Label(sixthframe,bg="#2E2E2E",fg="#fff")
day6temp.place(x=2,y=70)

#seventh cell
seventhframe=Frame(root,width=70,height=115,bg="#2E2E2E")
seventhframe.place(x=805, y=325)

day7=Label(seventhframe,bg="#2E2E2E",fg="#fff")
day7.place(x=10,y=5)

seventhimage=Label(seventhframe,bg="#2E2E2E")
seventhimage.place(x=7,y=20)

day7temp=Label(seventhframe,bg="#2E2E2E",fg="#fff")
